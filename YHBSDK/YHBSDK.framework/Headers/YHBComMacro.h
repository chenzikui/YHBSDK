...
#ifndef YHBComMacro_h
#define YHBComMacro_h
...
//颜色
#define YHBUIColorFromRGB(rgbValue) \
[UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16)) / 255.0 \
green:((float)((rgbValue & 0xFF00) >> 8)) / 255.0 \
blue:((float)(rgbValue & 0xFF)) / 255.0 \
alpha:1.0]
#define YHBUIColorFromRGBA(rgbValue, a) \
[UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16)) / 255.0 \
green:((float)((rgbValue & 0xFF00) >> 8)) / 255.0 \
blue:((float)(rgbValue & 0xFF)) / 255.0 \
alpha:a]
...
//加载本地图片
#define IMAGE(name)  [UIImage imageWithContentsOfFile:[[NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"YHBSDKBundle" withExtension:@"bundle"]] pathForResource:name ofType:@"png"]]

//尺寸
#define YHBScreenWidth                   ([[UIScreen mainScreen] bounds].size.width)
#define YHBScreenHeight                  ([[UIScreen mainScreen] bounds].size.height)

#define YHBIntToString(a)                [NSString stringWithFormat:@"%ld",a]
#define YHBIntegerToString(a)            [NSString stringWithFormat:@"%zi", a]
#define FONT(a)             [UIFont systemFontOfSize:a]
#define BFONT(a)            [UIFont boldSystemFontOfSize:a]

//主要颜色值
#define YHBAPPClearColor         [UIColor clearColor]
#define YHBAPPWhiteColor         [UIColor whiteColor]
#define YHBAPPBlackColor         [UIColor blackColor]

#define YHBAPPMainColor          YHBUIColorFromRGB(0xff5c34)  /**<  APP主颜色（红）  */
#define YHBAPPQMainColor         YHBUIColorFromRGB(0xfff1ee)

#define YHBAPPTipsColor          YHBUIColorFromRGB(0xaaaaaa)  //灰色
#define YHBAPPSubheadColor       YHBUIColorFromRGB(0x5a5a5a)  //深灰色
#define YHBAPPBGColor            YHBUIColorFromRGB(0xf4f4f4)  /**<  背景颜色  */
#define YHBAPPTitleColor         YHBUIColorFromRGB(0x323232)  /**<  标题颜色  */
#define YHBAPPSeparateColor      YHBUIColorFromRGB(0xeaeaea)
#define YHBAPPRemarkColor        YHBUIColorFromRGB(0xababab)
#define YHBAPPLabelTitleColor    YHBUIColorFromRGB(0x545454)  /**<  内容颜色  */
...
//屏幕百分比以6s为基础
#define YHBScreenWidthPercentage(a) (YHBScreenWidth*((a)/667.00))
#define YHBScreenHeightPercentage(a) (YHBScreenHeight *((a)/375.00))
